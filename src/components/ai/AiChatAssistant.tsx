...
const SUGGESTED_PROMPTS = [
  'Log $1,420 AWS server expense',
  'Draft $4,500 invoice to Acme Corp',
  'Show monthly software spending',
]
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome-1',
      sender: 'ai',
      text: 'Finly Assistant is ready. Enter an expense to log, invoice to draft, or query your cashflow.',
    ...
    setTimeout(() => {
      ...
      if (
        ...
        aiResponse = {
          id: 'ai-' + Date.now(),
          sender: 'ai',
          text: 'Review draft expense entry:',
          timestamp: new Date().toLocaleTimeString([], {
            hour: '2-digit',
            minute: '2-digit',
          }),
        ...
        aiResponse = {
          id: 'ai-' + Date.now(),
          sender: 'ai',
          text: 'Software and SaaS expense summary for this month:',
          timestamp: new Date().toLocaleTimeString([], {
            hour: '2-digit',
            minute: '2-digit',
          }),
        ...
        aiResponse = {
          id: 'ai-' + Date.now(),
          sender: 'ai',
          text: `I parsed: "${query}". You can log expenses, draft invoices, or query cashflow categories. Try: "Log $1,420 AWS server expense" or "Draft $4,500 invoice to Acme Corp".`,
          timestamp: new Date().toLocaleTimeString([], {
            hour: '2-digit',
            minute: '2-digit',
          }),
                ...
                <div className="flex items-center gap-2.5 sm:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] sm:text-xs text-muted-foreground flex items-center gap-1 mt-0.5">
                      ...
                      Confirmation required before ledger commit
                    </p>
                  </div>
                </div>
                <button
                            ...
                            <div className="pt-2">
                              {msg.intentCard.isApproved ? (
                                <div className="flex items-center justify-center gap-2 py-2 px-3 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-md text-xs font-semibold border border-emerald-500/20">
                                  ...
                                  {msg.intentCard.type === 'expense'
                                    ? 'Saved to cashbook'
                                    : 'Transferred to invoice builder'}
                                </div>
                              ) : (
                                <Button
                                  size="sm"
              ...
              <div className="p-4 border-t border-border bg-card">
                ...
                >
                  <input
                    ...
                    placeholder="Ask a question or enter a transaction..."
