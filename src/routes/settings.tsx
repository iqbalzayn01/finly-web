...
const AI_PROVIDERS: AIProvider[] = [
  ...
  },
  {
    ...
    models: [
      { id: 'claude-3-5-sonnet-20241022', name: 'Claude 3.5 Sonnet (Best Code & Logic)' },
      { id: 'claude-3-5-haiku-20241022', name: 'Claude 3.5 Haiku (Sub-second speed)' },
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'deepseek-reasoner', name: 'DeepSeek R1 (Chain-of-Thought Reasoner)' },
    ],
  },
  {
    id: 'custom',
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Update business name, tax identification, and logo displayed on customer invoices.
                </p>
              </div>
            </div>
          ...
          <div className="border border-border bg-card p-8 rounded-2xl shadow-none space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Configure default base currency and invoice numbering prefixes.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-border">
              ...
              <Button type="button" onClick={handleSaveProfileSettings} className="px-6 text-xs font-bold">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Connect external LLM engines (Gemini, ChatGPT, Claude, DeepSeek, or Local Ollama) to power Finly AI Assistant.
                </p>
              </div>
            </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className={cn('flex h-8 w-8 items-center justify-center rounded-lg border text-xs font-bold', prov.iconColor)}>
          ...
          <div className="p-6 rounded-xl bg-muted/40 border border-border space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              <div className="flex items-center gap-2">
                <span className={cn('px-2.5 py-1 text-xs font-bold rounded-lg border', currentProviderObj.badgeColor)}>
                  Active: {currentProviderObj.name}
                </span>
              </div>
              {testStatus === 'success' && testLatency && (
                <span className="text-xs font-semibold text-emerald-600 dark:text-emerald-400 flex items-center gap-1.5">
                  <CheckCircle2 className="h-4 w-4" /> Connection Verified ({testLatency}ms)
                </span>
              )}
            </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              {selectedProvider === 'custom' && (
                <div className="space-y-2 sm:col-span-2">
                  <label className="text-xs font-semibold text-foreground flex items-center gap-1.5">
                    <Server className="h-3.5 w-3.5 text-muted-foreground" /> Base Endpoint URL
                  </label>
                  <input
                    type="text"
              ...
              <div className="space-y-2">
                <label className="text-xs font-semibold text-foreground flex items-center justify-between">
                  <span className="flex items-center gap-1.5">
                    <Sliders className="h-3.5 w-3.5 text-muted-foreground" /> Temperature
                  </span>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-border flex-wrap gap-3">
              ...
              >
                {testStatus === 'testing' ? (
                  <>
                    <RefreshCw className="h-3.5 w-3.5 animate-spin text-primary" /> Testing API Ping...
                  </>
                ) : (
                  <>
              ...
              <div className="flex items-center gap-3">
                ...
                <Button type="button" onClick={handleSaveAISettings} className="px-5 text-xs font-bold">
                  Save AI Connections
                </Button>
              </div>
            </div>
